...
<Grid {items} bind:items cols={8} let:item rowHeight={100}>
...
<script>
  ...
  let items = [gridHelp.item({ x: 0, y: 0, w: 2, h: 2, id: id(), max: { w: 2 } }), gridHelp.item({ x: 2, y: 0, w: 3, h: 2, id: id(), max: { w: 3 } }), gridHelp.item({ x: 5, y: 0, w: 3, h: 3, id: id(), max: { w: 4 } })];
</script>
