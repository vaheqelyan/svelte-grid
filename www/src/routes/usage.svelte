...
<p>
  But you can apply styles to a selector globally, use the
  <b>:global(...)</b>
  modifier.
</p>
...
<ul>
  <li>
    <code>.svlt-grid-container</code>
    — Class name for container grid
  </li>
  <li>
    <code>.svlt-grid-item</code>
    — Slot shell class name
  </li>
  <li>
    <code>.svlt-grid-shadow</code>
    — Class name for the back shadow when resizing or moving an element
  </li>
  <li>
    <code>.svlt-grid-resizer</code>
    — Class name for resizer
  </li>
  <li>
    <code>.svlt-grid-resizer::after</code>
    — Class name for resizer
  </li>
  <li>
    <code>.svlt-grid-transition</code>
    — Apply the transition to the grid
  </li>
</ul>
...
<p>
  The helper function is located in
  <code>svelte-grid/build/helper/index.mjs</code>
</p>
...
<b>
  <code>
    <pre>{`gridHelp.item(item: Object)`}</pre>
  </code>
</b>
...
<b>
  <code>
    <pre>{`gridHelp.findSpaceForItem(item: Object, items: Array<Object>, cols: Number)`}</pre>
  </code>
</b>
...
<p>
  <a href="examples/add_remove">See example</a>
</p>
...
<b>
  <code>
    <pre>{`gridHelp.appendItem(item: Object, items: Array<Object>, cols: Number)`}</pre>
  </code>
</b>
...
<b>
  <code>
    <pre>{`gridHelp.resizeItems(item: Object, cols: Number, rows: Number)`}</pre>
  </code>
</b>
...
<p>
  <a href="https://github.com/vaheqelyan/svelte-grid/blob/master/www/src/routes/index.svelte" target="_blank">See example</a>
</p>
